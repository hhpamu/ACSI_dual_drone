...
static void powerDistributionLegacy(const control_t *control, motors_thrust_uncapped_t* motorThrustUncapped)
{
  ...
  // Single Drone
  //motorThrustUncapped->motors.m1 = control->thrust - r + p + control->yaw; //right
  //motorThrustUncapped->motors.m2 = control->thrust - r - p - control->yaw; //right
  //motorThrustUncapped->motors.m3 = control->thrust + r - p + control->yaw; //left
  //motorThrustUncapped->motors.m4 = control->thrust + r + p - control->yaw; //left

  //left
  motorThrustUncapped->motors.m1 = control->thrust + (float)0.73*r + p + control->yaw; //right
  motorThrustUncapped->motors.m2 = control->thrust + (float)0.73*r - p - control->yaw; //right
  motorThrustUncapped->motors.m3 = control->thrust + (float)1.25*r - p + control->yaw; //left
  motorThrustUncapped->motors.m4 = control->thrust + (float)1.25*r + p - control->yaw; //left

  // //right
  //motorThrustUncapped->motors.m1 = control->thrust - (float)1.25*r + p + control->yaw; //right
  //motorThrustUncapped->motors.m2 = control->thrust - (float)1.25*r - p - control->yaw; //right
  //motorThrustUncapped->motors.m3 = control->thrust - (float)0.73*r - p + control->yaw; //left
  //motorThrustUncapped->motors.m4 = control->thrust - (float)0.73*r + p - control->yaw; //left
